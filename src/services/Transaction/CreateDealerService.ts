...
class CreateDealerService {
    async execute({ type, value, sector_id, valueReceive, valueDebit, club_id, paid, client_id, methods_transaction, items_transaction, operation, date_payment, observation }: TransactionRequest) {
