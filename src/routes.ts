...
import { DeleteRankingController } from "./controllers/Ranking/DeleteProductController";
import { ListRankingsController } from "./controllers/Ranking/ListRankingsController";
import { EditRankingController } from "./controllers/Ranking/EditRankingController";
import { CreateRankingController } from "./controllers/Ranking/CreateRankingController";
...
router.get("/group/vacancys", new ListGroupVacancyController().handle);
...
router.get("/rankings", new ListRankingsController().handle);
router.get("/ranking/:ranking_id", new GetRankingController().handle);
router.delete("/ranking/:ranking_id", new DeleteRankingController().handle);
router.put("/start/ranking/:ranking_id", new StartRankingController().handle);
router.put("/stop/ranking/:ranking_id", new FinishRankingController().handle);
