...
class AddTournamentController {
    async handle(req: Request, res: Response) {
        const { client_id, chair, tournament_id, timechip, value, purchases, date_payment, observation, methods_transaction} = req.body
