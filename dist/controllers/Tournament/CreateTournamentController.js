...
exports.CreateTournamentController = void 0;
var _CreateTournamentService = require("../../services/Tournament/CreateTournamentService");
class CreateTournamentController {
  async handle(req, res) {
    ...
    const blindsArray = blindsRes.split("-");
    let intervals = "";
    let i = 1;
    let iT = 1;
    ...
    const createTournamentService =
      new _CreateTournamentService.CreateTournamentService();
    ...
    console.log("CreateTournament response:", tournament);
