...
exports.PaymentComandService = void 0;
  ...
  async execute({
    ...
    await Promise.all(client.transactions.map(async item => {
      let {
        ...
        methodsPay,
        methodsC
      } = await (0, _functions.getMethodsPay)(item.value - item.value_paid, methods_transactionC);
...
exports.PaymentComandService = PaymentComandService;