...
exports.GetFinancialBoxService = void 0;
...
class GetFinancialBoxService {
  async execute({
    ...
    let financialBox = await _prisma.default.financialBox.findFirst({
      where: {
        id: box_id,
        club_id: club_id
      },
...
exports.GetFinancialBoxService = GetFinancialBoxService;